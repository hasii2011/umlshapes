...
class Identifiers:
    ...
    ID_DISPLAY_UML_NOTE_LINK:   ID_REFERENCE = wxNewIdRef()

    ID_DISPLAY_ORTHOGONAL_LINK:  ID_REFERENCE = wxNewIdRef()
    ID_DISPLAY_SEQUENCE_DIAGRAM: ID_REFERENCE = wxNewIdRef()
    ID_CREATE_SD_MESSAGE:        ID_REFERENCE = wxNewIdRef()

    ID_SOURCE_TOP:    ID_REFERENCE = wxNewIdRef()
    ID_SOURCE_BOTTOM: ID_REFERENCE = wxNewIdRef()
    ID_SOURCE_LEFT:   ID_REFERENCE = wxNewIdRef()
    ID_SOURCE_RIGHT:  ID_REFERENCE = wxNewIdRef()
    ID_SOURCE_225:    ID_REFERENCE = wxNewIdRef()
