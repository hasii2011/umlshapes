...
class UmlActorV1(ControlPointMixin, DrawnShape):
    """
    ...
    def _drawBodyAndArms(self, dc, actorMinSize: int, actorHeight, actorWidth, centerX, y: int) -> Tuple[int, int]:
        """
        Draw body and arms
        Args:
            dc
